...
public class RetrainSample {
    ...
    public RetrainSample() {}

    public RetrainSample(String bucket, String key, Double startTime, Double stopTime, Boolean algCorrect) {
        this.bucket = bucket;
        this.key = key;
    ...
    public boolean equals(Object o) {
        ...
        RetrainSample that = (RetrainSample) o;
