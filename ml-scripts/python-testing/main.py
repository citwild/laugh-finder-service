...
def showTestModel(bucket, key, arffFilePath, matchFile=None, windowSize=800, stepSize=100, isTest=True,
                  amplitudeFilter=True, diffFilter=False):
    params = 'windowSize: %s, stepSize: %s, isTest: %s, applyFilter: %s, diffFilter: %s' % (
    windowSize, stepSize, isTest, amplitudeFilter, diffFilter)
    print(params)
    ...
    feature_array = file_feature_extraction(audio_file, window_size_in_sec, step_size_in_sec, amplitudeFilter,
                                            diffFilter)
